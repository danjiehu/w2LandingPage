...
In the [template](https://github.com/lewagon/china-product/raw/master/02-javascript/exercises/dom-events.zip) downloaded in previous exercise, open the `index.html` file in the browser. You can see we are using Bootstrap. Also, there is a big button in the `<body />`.
